...
BEST_MODEL_FILE = (
    "ALRL_v2_fold4_best_distill.pt"
)

FINAL_MODEL_FILE = (
    "ALRL_v2_fold4_final_distill.pt"
)

HISTORY_FILE = (
    "ALRL_v2_fold4_distill_history.csv"
)

BEST_CM_FILE = (
    "ALRL_v2_fold4_distill_confusion_best.csv"
)

BEST_REPORT_FILE = (
    "ALRL_v2_fold4_distill_report_best.csv"
)
...
if sum(stage_dims) != 298:
    raise RuntimeError(
        f"Expected 298 V2 binary features, got {sum(stage_dims)}"
    )
...
print("\n===================================")
print("START ALRL V2 KNOWLEDGE DISTILLATION")
print("===================================")
...
print("\n===================================")
print("BEST V2 DISTILLED STUDENT RESULT")
print("===================================")
...
print("\n===================================")
print("BEST V2 DISTILLED PER-CLASS METRICS")
print("===================================")
...
print("V2 no-distillation baseline:")
print("Accuracy = 0.9932")
print("Macro F1 = 0.9864")

print(
    "KD Macro F1 gain over V2 no-KD = "
    f"{best_result['f1'] - 0.9864:+.4f}"
)

print(
    "KD Accuracy gain over V2 no-KD = "
    f"{best_result['accuracy'] - 0.9932:+.4f}"
)

print("Teacher Macro F1 = 0.9949")

print(
    "Remaining Macro F1 gap to Teacher = "
    f"{0.9949 - best_result['f1']:+.4f}"
)
